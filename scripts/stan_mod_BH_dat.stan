...
model {
  ...
  // sigma_y_h ~ normal(0,10); 
    ...
    N_e_sum_start_log ~  normal(13.8, 5); //normal(14, 8);  starting value for eggs, initiates pop model 
 ...
 for(t in 1:t_start){
    ...
    N_egg_start_log[t] ~  normal(13.8, 5); // starting value for eggs, initiates pop model 
}
